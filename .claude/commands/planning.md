...
5. **Surface risks**: Flag potential issues (breaking changes, data schema conflicts)

## Output Format

Produce numbered task lists with:
...
- Consider both Copilot and Claude Code workflows
